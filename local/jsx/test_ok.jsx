class Interaction extends React.Component {
  ...
  render() {
    return (
      <div>
        <div style={{width: '100%'}}>
          <Typography align="center" variant="h1" gutterBottom>OK</Typography>
        </div>
        ...
        <div style={{display: 'table', width: '100%'}}>
          ...
          <div style={{display: 'table-cell', textAlign: 'left', verticalAlign: 'middle'}}>
            <Typography variant="subtitle1" gutterBottom>Alle Test waren erfolgreich.</Typography>
            <Typography variant="subtitle1" gutterBottom>Auf zum nächsten Board!</Typography>
          </div>
        </div>
        <div style={{width: '100%', textAlign: 'center', verticalAlign: 'middle', padding: '2em'}}>
          <div style={{display: 'inline', paddingLeft: '2em', paddingRight: '2em'}}>
            <Button variant="extendedFab" onClick={this.handleButtonNext}>
              <SvgIcon>
          ...
          <div style={{display: 'inline', paddingLeft: '2em', paddingRight: '2em'}}>
            <Button variant="extendedFab" onClick={this.handleButtonQuit}>
              <SvgIcon>
